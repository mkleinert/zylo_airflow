...
def top_teams(ds,**kwargs):
    data = pandas.read_csv('/home/vagrant/baseballdatabank-master/core/Teams.csv')
    teams = pandas.read_csv('/home/vagrant/baseballdatabank-master/core/TeamsFranchises.csv')
    ...
    top_teams_final.to_csv('/home/vagrant/baseballdatabank-master/core/top_teams_final.csv', sep='\t',index=False)

def bulk_load_teams(table_name, **kwargs):
    local_filepath = '/home/vagrant/baseballdatabank-master/core/top_teams_final.csv'
